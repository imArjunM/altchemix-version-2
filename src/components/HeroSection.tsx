    ...
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10 pt-32 pb-20">
        ...
        >
          ...
          >
            Precision{" "}
            <span className="gradient-text">Polymer</span>
            <br />
            Engineering
          </motion.h1>
          ...
          >
            Advanced masterbatch and additive solutions that transform raw polymers 
            into high-performance materials. Trusted by industry leaders worldwide.
          </motion.p>
